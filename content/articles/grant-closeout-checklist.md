---
title: 'Grant Closeout Checklist: Federal and Private Grants'
description: A grant closeout checklist for nonprofit recipients — final reports, liquidation, refunds, property and records — with the federal 120-day rule under 2 CFR 200.344.
summary: >-
  Closing out a grant means submitting every required final report, liquidating obligations, refunding
  unspent funds you are not authorized to keep, settling property, and filing the records. Federal
  recipients must do this within 120 calendar days after the period of performance ends; subrecipients
  report to their pass-through entity within 90. For foundation grants, the award letter controls.
category: checklist
primaryKeyword: grant closeout checklist
keywords:
...
faq:
  - q: How long do we have to close out a federal grant?
    a: Under 2 CFR 200.344, a recipient must submit all required reports — financial, performance and anything else the award names — and liquidate all financial obligations no later than 120 calendar days after the period of performance ends. A subrecipient has 90 calendar days to report to its pass-through entity.
  - q: What happens if we miss the closeout deadline?
    a: 2 CFR 200.344 directs the federal agency to report a recipient's material failure to comply — including failure to submit final reports — in SAM.gov, the system other agencies check before making awards. Late closeout is therefore visible to every future federal funder, which is why the 120 days deserve a named owner and a start date well before day one of the window.
  - q: What do we do with unspent grant funds at closeout?
    a: For federal awards, promptly refund any unobligated funds the agency paid that you are not authorized to retain (2 CFR 200.344). For foundation grants, the agreement controls — some funders allow reallocation on request, others expect a return. Ask in writing before assuming either.
  - q: How long do we keep records after closeout?
    a: Federal award records must be kept for three years from the date you submit the final financial report — not three years from the end of the grant — with longer retention while any litigation, claim or audit finding is open, and three years after final disposition for property records (2 CFR 200.334). Treat the same three-year floor as a default for private grants that are silent on retention.
sources:
