---
title: "Federal Grant Compliance Checklist: 2 CFR 200"
description: "Use this federal grant compliance checklist to organize cost support, procurement, reporting, subrecipient monitoring, audits, and closeout records."
summary: >-
  Federal grant compliance means applying your award terms and applicable rules to spending, purchasing, reporting, records, and closeout. Start with a requirement register that names an owner and evidence for every obligation. This checklist connects core 2 CFR 200 requirements to practical records; your agency rules, award conditions, and applicable version still control.
category: checklist
primaryKeyword: federal grant compliance checklist
keywords: [2 CFR 200 checklist, federal grant management, grant compliance training, single audit threshold, federal grant reporting]
intent: informational
publishedAt: 2026-09-22
updatedAt: 2026-09-22
factCheckedAt: 2026-09-22
author: GrantConsole editorial team
brief: briefs/07-federal-grant-compliance-checklist.md
draft: false
faq:
  - q: What is federal grant management?
    a: Federal grant management is the administration of an award from setup through reporting and closeout, including spending controls, performance oversight, records, and applicable audit responsibilities. Requirements come from the award, agency rules, and the applicable federal framework.
  - q: What is the current Single Audit threshold?
    a: For a non-Federal entity subject to Subpart F, the threshold is $1,000,000 in federal awards expended during its fiscal year, for fiscal years beginning on or after October 1, 2024. It is not a per-grant or cash-receipt threshold. Earlier fiscal years and entities outside that scope require separate review.
  - q: How long must federal grant records be retained?
    a: The general rule is three years from submission of the final financial report, with different triggers for certain records and exceptions for matters such as unresolved audits or litigation. Do not use the award end date as an automatic destruction date.
  - q: Does grant management software make a nonprofit compliant?
    a: No. Software can organize entered obligations, evidence, and review work, but staff remain responsible for interpreting requirements, making supported decisions, and submitting accurate reports through the required channels.
sources:
  - title: 2 CFR 200.101 Applicability
    url: https://www.ecfr.gov/current/title-2/section-200.101
    checked: 2026-09-22
  - title: 2 CFR 200.110 Effective date
    url: https://www.ecfr.gov/current/title-2/section-200.110
    checked: 2026-09-22
  ...
  - title: 2 CFR 200.403 Factors affecting allowability of costs
    ...
    checked: 2026-09-22
  - title: 2 CFR 200.405 Allocable costs
    url: https://www.ecfr.gov/current/title-2/section-200.405
    checked: 2026-09-22
  - title: 2 CFR 200.430 Compensation personal services
    url: https://www.ecfr.gov/current/title-2/section-200.430
    checked: 2026-09-22
  - title: 2 CFR 200.318 General procurement standards
    url: https://www.ecfr.gov/current/title-2/section-200.318
    checked: 2026-09-22
  - title: 2 CFR 200.320 Procurement methods
    url: https://www.ecfr.gov/current/title-2/section-200.320
    checked: 2026-09-22
  - title: 2 CFR 200.327 Contract provisions
    url: https://www.ecfr.gov/current/title-2/section-200.327
    checked: 2026-09-22
  - title: 2 CFR 200.331 Subrecipient and contractor determinations
    url: https://www.ecfr.gov/current/title-2/section-200.331
    checked: 2026-09-22
  - title: 2 CFR 200.332 Requirements for pass-through entities
    url: https://www.ecfr.gov/current/title-2/section-200.332
    checked: 2026-09-22
  ...
  - title: 2 CFR 200.501 Audit requirements
    ...
    checked: 2026-09-22
  - title: Federal Audit Clearinghouse eligibility
    url: https://www.fac.gov/_collections/walkthrough/04-eligibility/
    checked: 2026-09-22
  - title: 2 CFR 200.512 Report submission
    url: https://www.ecfr.gov/current/title-2/section-200.512
    checked: 2026-09-22
  - title: 2 CFR 200.344 Closeout
    url: https://www.ecfr.gov/current/title-2/section-200.344
    checked: 2026-09-22
  - title: GrantConsole documented capabilities
    url: https://grantconsole.com/
    checked: 2026-09-22
related: [post-award-grant-management, track-multiple-grants-without-missing-deadlines, post-award-grant-management-checklist, audit-ready-grant-file, grant-closeout-checklist]
---
...
This checklist covers core recipient responsibilities. It is not a complete assessment of every federal program. Read your notice of award, amendments, agency implementation, pass-through conditions, and applicable version of the Uniform Guidance together. [Section 200.101](https://www.ecfr.gov/current/title-2/section-200.101) explains applicability, including situations that receive different treatment. [Section 200.110](https://www.ecfr.gov/current/title-2/section-200.110) addresses implementation timing. Older awards should not automatically be treated as though every current revision applies to them.
...
Start one requirement register with the award identifier, source section, responsible person, due date, required evidence, reviewer, and completion record. Keep the original instruction beside your interpretation. The [post-award grant management guide](/resources/post-award-grant-management) explains recipient responsibilities; the [post-award checklist](/resources/post-award-grant-management-checklist) covers award setup. For coordinating several awards, use the [multi-grant tracking workflow](/resources/track-multiple-grants-without-missing-deadlines).
...
**Rule:** Recipients and subrecipients must establish, document, and maintain effective internal controls, monitor compliance, and take “prompt action” when noncompliance is identified. The section also addresses safeguarding sensitive information. [Read 2 CFR 200.303](https://www.ecfr.gov/current/title-2/section-200.303).
...
**Rule:** An allowable cost must meet the section's combined criteria, including necessity, reasonableness, allocability, consistent treatment, and documentation. The regulatory phrase is “adequately documented.” Budget availability alone does not establish allowability. [Read 2 CFR 200.403](https://www.ecfr.gov/current/title-2/section-200.403).
...
**Rule:** Allocation follows “relative benefits received.” A cost assigned to one federal award cannot simply be moved to another to cover a funding shortage or avoid restrictions. [Read 2 CFR 200.405](https://www.ecfr.gov/current/title-2/section-200.405).

**Produce:** The allocation method, underlying records, calculation, reviewer approval, and explanations for changes. For employee compensation, also assess the records against [2 CFR 200.430](https://www.ecfr.gov/current/title-2/section-200.430), rather than assuming a budget estimate is sufficient support.
...
**Rule:** Section 200.318 requires documented procedures, conflict-of-interest standards, contractor oversight, and “procurement records.” The history must explain the procurement method, contract type selection, contractor selection or rejection, and price basis. [Read 2 CFR 200.318](https://www.ecfr.gov/current/title-2/section-200.318).
...
**Common failure:** A preferred supplier is selected first and the competition record is assembled afterward. [Section 200.320](https://www.ecfr.gov/current/title-2/section-200.320) distinguishes informal, formal, and noncompetitive methods. Do not assume one universal dollar threshold applies to every organization, date, and transaction; check the current definitions, permitted exceptions, and your documented procedures. Contracts also need the applicable Appendix II provisions required by [section 200.327](https://www.ecfr.gov/current/title-2/section-200.327).
...
**Rule:** Classification follows the substance of the relationship under [section 200.331](https://www.ecfr.gov/current/title-2/section-200.331). If your nonprofit acts as a pass-through entity by making a subaward, section 200.332 requires assessment of fraud and noncompliance risk and monitoring, including review of “financial and performance reports.” It also addresses required subaward information, exclusion checks, audit verification, and follow-up. [Read 2 CFR 200.332](https://www.ecfr.gov/current/title-2/section-200.332).
...
**Common failure:** The team deletes records three years after the award end date. Another is retaining a spreadsheet of links after the linked documents or former employee's account have disappeared. Test retrieval with someone who did not create the file. The [grant file guide](/resources/audit-ready-grant-file) provides a practical organization structure.
...
**Common failure:** The organization counts only direct federal grants and overlooks federal subawards. Being below the threshold does not remove award duties or record-access requirements. Consult the applicable rules for unusual funding and entity types. Under [section 200.512](https://www.ecfr.gov/current/title-2/section-200.512), submission is generally due by the earlier of 30 calendar days after receipt of the auditor's reports or nine months after the audit period ends, subject to the section's extension and nonbusiness-day provisions.
...
GrantConsole attaches evidence to deliverables and displays explainable warnings about entered deadlines and records. Those mechanics can support the work involved in financial and performance reporting, but a stored file still needs review. [GrantConsole's public product description](https://grantconsole.com/) documents the capabilities summarized below.
