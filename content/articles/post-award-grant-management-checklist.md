...
description: Post-award grant checklist for nonprofit recipients covering deadlines, restricted budgets, evidence, reports, prior approvals, closeout and retention, sourced to 2 CFR 200.
summary: >-
  A post-award grant management checklist covers eight stages: accept and set up the award, build the
  obligation calendar with named owners, set up the restricted budget, design the evidence system, run the
  reporting cadence, watch for changes that need prior approval, close out on time, and retain records for
  audit. Federal deadlines come from 2 CFR part 200; for foundation grants, the award letter controls.
category: checklist
...
faq:
  - q: What belongs in a post-award grant management checklist?
    a: The obligations attached to money already won — award terms and restrictions, every reporting and deliverable deadline with an owner, a restricted budget tracked against the grant period, evidence for each deliverable, prior-approval triggers, closeout steps and record retention. Each item should name who owns it and where the proof lives.
  - q: How long after a federal grant ends are final reports due?
    a: Under 2 CFR 200.344, recipients must submit all required financial, performance and other reports and liquidate obligations no later than 120 calendar days after the period of performance ends. Subrecipients report to their pass-through entity within 90 calendar days. Extensions must be requested and approved.
  - q: How long do we need to keep grant records?
    a: 2 CFR 200.334 requires recipients to retain federal award records for three years from the date they submit the final financial report, with longer periods if litigation, claims or audit findings are open, and separate rules for property, program income and indirect cost proposals. Foundation agreements set their own terms, so check the award letter.
  - q: How often should a nonprofit review its post-award checklist?
    a: Monthly for the portfolio and weekly for anything due in the next 30 days. A monthly review catches budget burn drifting from the grant period and evidence gaps; a weekly look at the next 30 days keeps report submissions on time.
sources:
  ...
  - title: 2 CFR 200.302 — Financial management
    ...
    checked: 2026-08-17
  - title: 2 CFR 200.308 — Revision of budget and program plans (prior approvals, no-cost extensions)
...
Federal awards are governed by the Uniform Guidance in [2 CFR part 200](https://www.ecfr.gov/current/title-2/part-200); every federal item below cites the section it comes from and was checked against the eCFR on the date shown at the top of the page. Foundation and corporate grants have no single rulebook. For those, the award letter or grant agreement controls, and the checklist tells you which clauses to look for.
